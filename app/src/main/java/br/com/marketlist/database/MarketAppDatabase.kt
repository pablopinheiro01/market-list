...
val MIGRATION_1_TO_2 = object: Migration(1,2){
    override fun migrate(database: SupportSQLiteDatabase) {
        ...
        database.execSQL("CREATE TABLE IF NOT EXISTS ProductItemCopy (`id` INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, `name` TEXT NOT NULL, `bought` INTEGER NOT NULL, `idListMarket` INTEGER NOT NULL DEFAULT 0, FOREIGN KEY(`idListMarket`) REFERENCES `ListMarket`(`id`) ON UPDATE NO ACTION ON DELETE CASCADE )")
